...
class TrainConfig(BaseModel):
    ...
    # Due to unknown issue, some ids in annotation volume
    #             are not in terminology. Ashwin Bhandiwad created this json file which maps these
    terminology_correction_path: Path

    # np files generated by create_train_val_test_split.py
    train_samples_path: Path
    val_samples_path: Path

    multi_task_loss_init_weights: Optional[list[float]] = None
